...
public class NVPAPICaller
{
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:44388/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:44388/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "Rock It Gear Sample Application";
        ...
        using (RockItGear.Logic.ShoppingCartActions myCartOrders = new RockItGear.Logic.ShoppingCartActions())
        {
